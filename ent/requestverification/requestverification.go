...
const (
	// Label holds the string label denoting the requestverification type in the database.
	...
	// Table holds the table name of the requestverification in the database.
	Table = "request_verifications"
	// UserTable is the table that holds the user relation/edge. The primary key declared below.
	UserTable = "request_verification_user"
	...
	BusinessTable = "request_verification_business"
...
// Columns holds all SQL columns for requestverification fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
var (
	...
	UserPrimaryKey = []string{"request_verification_id", "user_id"}
	// BusinessPrimaryKey and BusinessColumn2 are the table columns denoting the
	// primary key for the business relation (M2M).
	BusinessPrimaryKey = []string{"request_verification_id", "business_id"}
)
...
func StatusValidator(s Status) error {
	...
	case StatusPENDING, StatusIN_PROGRESS, StatusVERIFIED, StatusFAILED, StatusREJECTED, StatusEXPIRED:
		return nil
	default:
		return fmt.Errorf("requestverification: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the RequestVerification queries.
