...
const (
	// Label holds the string label denoting the stablecoinwithdrawal type in the database.
	Label = "stablecoin_withdrawal"
	...
	// Table holds the table name of the stablecoinwithdrawal in the database.
	Table = "stablecoin_withdrawals"
	// TransactionTable is the table that holds the transaction relation/edge.
	TransactionTable = "stablecoin_withdrawals"
...
// Columns holds all SQL columns for stablecoinwithdrawal fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the StablecoinWithdrawal queries.
