...
type TransactionQuery struct {
	...
	withNubanDeposit          *NubanDepositQuery
	withNubanTransfer         *NubanTransferQuery
	withWallet                *WalletQuery
	withStablecoinDeposit     *StablecoinDepositQuery
	withStablecoinWithdrawal  *StablecoinWithdrawalQuery
	withLedgerEntries         *LedgerQuery
	withReversalLedgerEntries *LedgerQuery
	withFKs                   bool
...
// QueryNubanDeposit chains the current query on the "nuban_deposit" edge.
func (tq *TransactionQuery) QueryNubanDeposit() *NubanDepositQuery {
	query := (&NubanDepositClient{config: tq.config}).Query()
...
// QueryNubanTransfer chains the current query on the "nuban_transfer" edge.
func (tq *TransactionQuery) QueryNubanTransfer() *NubanTransferQuery {
	query := (&NubanTransferClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryStablecoinDeposit chains the current query on the "stablecoin_deposit" edge.
func (tq *TransactionQuery) QueryStablecoinDeposit() *StablecoinDepositQuery {
	query := (&StablecoinDepositClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryStablecoinWithdrawal chains the current query on the "stablecoin_withdrawal" edge.
func (tq *TransactionQuery) QueryStablecoinWithdrawal() *StablecoinWithdrawalQuery {
	query := (&StablecoinWithdrawalClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (tq *TransactionQuery) QueryLedgerEntries() *LedgerQuery {
	query := (&LedgerClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryReversalLedgerEntries chains the current query on the "reversal_ledger_entries" edge.
func (tq *TransactionQuery) QueryReversalLedgerEntries() *LedgerQuery {
	query := (&LedgerClient{config: tq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := tq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (tq *TransactionQuery) Clone() *TransactionQuery {
	...
	return &TransactionQuery{
		...
		withNubanDeposit:          tq.withNubanDeposit.Clone(),
		withNubanTransfer:         tq.withNubanTransfer.Clone(),
		withWallet:                tq.withWallet.Clone(),
		withStablecoinDeposit:     tq.withStablecoinDeposit.Clone(),
		withStablecoinWithdrawal:  tq.withStablecoinWithdrawal.Clone(),
		withLedgerEntries:         tq.withLedgerEntries.Clone(),
		withReversalLedgerEntries: tq.withReversalLedgerEntries.Clone(),
...
// WithNubanDeposit tells the query-builder to eager-load the nodes that are connected to
// the "nuban_deposit" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TransactionQuery) WithNubanDeposit(opts ...func(*NubanDepositQuery)) *TransactionQuery {
	query := (&NubanDepositClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withNubanDeposit = query
	return tq
}

// WithNubanTransfer tells the query-builder to eager-load the nodes that are connected to
// the "nuban_transfer" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TransactionQuery) WithNubanTransfer(opts ...func(*NubanTransferQuery)) *TransactionQuery {
	query := (&NubanTransferClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withNubanTransfer = query
	return tq
}
...
// WithStablecoinDeposit tells the query-builder to eager-load the nodes that are connected to
// the "stablecoin_deposit" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TransactionQuery) WithStablecoinDeposit(opts ...func(*StablecoinDepositQuery)) *TransactionQuery {
	query := (&StablecoinDepositClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withStablecoinDeposit = query
	return tq
}

// WithStablecoinWithdrawal tells the query-builder to eager-load the nodes that are connected to
// the "stablecoin_withdrawal" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TransactionQuery) WithStablecoinWithdrawal(opts ...func(*StablecoinWithdrawalQuery)) *TransactionQuery {
	query := (&StablecoinWithdrawalClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withStablecoinWithdrawal = query
	return tq
}
...
func (tq *TransactionQuery) WithLedgerEntries(opts ...func(*LedgerQuery)) *TransactionQuery {
	query := (&LedgerClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withLedgerEntries = query
	return tq
}

// WithReversalLedgerEntries tells the query-builder to eager-load the nodes that are connected to
// the "reversal_ledger_entries" edge. The optional arguments are used to configure the query builder of the edge.
func (tq *TransactionQuery) WithReversalLedgerEntries(opts ...func(*LedgerQuery)) *TransactionQuery {
	query := (&LedgerClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	tq.withReversalLedgerEntries = query
	return tq
}
...
func (tq *TransactionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Transaction, error) {
	var (
		...
		_spec       = tq.querySpec()
		loadedTypes = [7]bool{
			tq.withNubanDeposit != nil,
			tq.withNubanTransfer != nil,
			tq.withWallet != nil,
			tq.withStablecoinDeposit != nil,
			tq.withStablecoinWithdrawal != nil,
			tq.withLedgerEntries != nil,
			tq.withReversalLedgerEntries != nil,
		}
	)
	...
	if query := tq.withNubanDeposit; query != nil {
		if err := tq.loadNubanDeposit(ctx, query, nodes, nil,
			func(n *Transaction, e *NubanDeposit) { n.Edges.NubanDeposit = e }); err != nil {
			return nil, err
		}
	}
	if query := tq.withNubanTransfer; query != nil {
		if err := tq.loadNubanTransfer(ctx, query, nodes, nil,
			func(n *Transaction, e *NubanTransfer) { n.Edges.NubanTransfer = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := tq.withStablecoinDeposit; query != nil {
		if err := tq.loadStablecoinDeposit(ctx, query, nodes, nil,
			func(n *Transaction, e *StablecoinDeposit) { n.Edges.StablecoinDeposit = e }); err != nil {
			return nil, err
		}
	}
	if query := tq.withStablecoinWithdrawal; query != nil {
		if err := tq.loadStablecoinWithdrawal(ctx, query, nodes, nil,
			func(n *Transaction, e *StablecoinWithdrawal) { n.Edges.StablecoinWithdrawal = e }); err != nil {
			return nil, err
		}
	}
	if query := tq.withLedgerEntries; query != nil {
		if err := tq.loadLedgerEntries(ctx, query, nodes,
			func(n *Transaction) { n.Edges.LedgerEntries = []*Ledger{} },
			func(n *Transaction, e *Ledger) { n.Edges.LedgerEntries = append(n.Edges.LedgerEntries, e) }); err != nil {
			return nil, err
		}
	}
	if query := tq.withReversalLedgerEntries; query != nil {
		if err := tq.loadReversalLedgerEntries(ctx, query, nodes,
			func(n *Transaction) { n.Edges.ReversalLedgerEntries = []*Ledger{} },
			func(n *Transaction, e *Ledger) {
				n.Edges.ReversalLedgerEntries = append(n.Edges.ReversalLedgerEntries, e)
			}); err != nil {
			return nil, err
		}
	}
...
func (tq *TransactionQuery) loadNubanDeposit(ctx context.Context, query *NubanDepositQuery, nodes []*Transaction, init func(*Transaction), assign func(*Transaction, *NubanDeposit)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(nubandeposit.FieldTransactionID)
	}
	query.Where(predicate.NubanDeposit(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(transaction.NubanDepositColumn), fks...))
	}))
...
func (tq *TransactionQuery) loadNubanTransfer(ctx context.Context, query *NubanTransferQuery, nodes []*Transaction, init func(*Transaction), assign func(*Transaction, *NubanTransfer)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Transaction)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.NubanTransfer(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(transaction.NubanTransferColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.transaction_nuban_transfer
		if fk == nil {
			return fmt.Errorf(`foreign-key "transaction_nuban_transfer" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "transaction_nuban_transfer" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (tq *TransactionQuery) loadWallet(ctx context.Context, query *WalletQuery, nodes []*Transaction, init func(*Transaction), assign func(*Transaction, *Wallet)) error {
	...
	nodeids := make(map[string][]*Transaction)
	for i := range nodes {
		if nodes[i].transaction_wallet == nil {
			continue
		}
		fk := *nodes[i].transaction_wallet
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "transaction_wallet" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (tq *TransactionQuery) loadStablecoinDeposit(ctx context.Context, query *StablecoinDepositQuery, nodes []*Transaction, init func(*Transaction), assign func(*Transaction, *StablecoinDeposit)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Transaction)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(stablecoindeposit.FieldTransactionID)
	}
	query.Where(predicate.StablecoinDeposit(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(transaction.StablecoinDepositColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (tq *TransactionQuery) loadStablecoinWithdrawal(ctx context.Context, query *StablecoinWithdrawalQuery, nodes []*Transaction, init func(*Transaction), assign func(*Transaction, *StablecoinWithdrawal)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Transaction)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(stablecoinwithdrawal.FieldTransactionID)
	}
	query.Where(predicate.StablecoinWithdrawal(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(transaction.StablecoinWithdrawalColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (tq *TransactionQuery) loadLedgerEntries(ctx context.Context, query *LedgerQuery, nodes []*Transaction, init func(*Transaction), assign func(*Transaction, *Ledger)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Transaction)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(ledger.FieldTransactionID)
	}
...
func (tq *TransactionQuery) loadReversalLedgerEntries(ctx context.Context, query *LedgerQuery, nodes []*Transaction, init func(*Transaction), assign func(*Transaction, *Ledger)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Transaction)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(ledger.FieldReversalTransactionID)
	}
	query.Where(predicate.Ledger(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(transaction.ReversalLedgerEntriesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.ReversalTransactionID
		node, ok := nodeids[fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "reversal_transaction_id" returned %v for node %v`, fk, n.ID)
		}
		assign(node, n)
	}
	return nil
