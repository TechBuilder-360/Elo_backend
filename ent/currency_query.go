...
func (cq *CurrencyQuery) QueryWallets() *WalletQuery {
...
func (cq *CurrencyQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (cq *CurrencyQuery) FirstIDX(ctx context.Context) string {
...
func (cq *CurrencyQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (cq *CurrencyQuery) OnlyIDX(ctx context.Context) string {
...
func (cq *CurrencyQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (cq *CurrencyQuery) IDsX(ctx context.Context) []string {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (cq *CurrencyQuery) WithWallets(opts ...func(*WalletQuery)) *CurrencyQuery {
	query := (&WalletClient{config: cq.config}).Query()
...
func (cq *CurrencyQuery) loadWallets(ctx context.Context, query *WalletQuery, nodes []*Currency, init func(*Currency), assign func(*Currency, *Wallet)) error {
	...
	query.Where(predicate.Wallet(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(currency.WalletsColumn), fks...))
	}))
