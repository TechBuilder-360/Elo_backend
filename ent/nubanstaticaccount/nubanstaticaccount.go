...
const (
	// Label holds the string label denoting the nubanstaticaccount type in the database.
	Label = "nuban_static_account"
	...
	EdgeWallet = "wallet"
	// Table holds the table name of the nubanstaticaccount in the database.
	Table = "nuban_static_accounts"
	// WalletTable is the table that holds the wallet relation/edge.
	WalletTable = "nuban_static_accounts"
	...
	WalletColumn = "wallet_nuban_static_account"
)

// Columns holds all SQL columns for nubanstaticaccount fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "nuban_static_accounts"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"wallet_nuban_static_account",
}
...
func StateValidator(s State) error {
	...
	case StateOPEN, StateSUSPENDED, StateCLOSED:
		return nil
	default:
		return fmt.Errorf("nubanstaticaccount: invalid enum value for state field: %q", s)
	}
}

// OrderOption defines the ordering options for the NubanStaticAccount queries.
