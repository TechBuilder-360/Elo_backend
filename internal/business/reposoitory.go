...
type IRepository interface {
	...
	UpdateBusinessLocation(ctx context.Context, b *ent.Business, address BusinessAddress) error
	AddDocument(ctx context.Context, b *ent.Business, payload AddBusinessDocument) error
	...
	GetManager(ctx context.Context, user *ent.User, b *ent.Business) (*ent.Manager, error)
